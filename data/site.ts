...
export const aboutIntro = {
  body: [
    ...
    '長崎県在住のWebエンジニア・濵口翔（PHP / Laravel）が個人で『補助金ナビ 長崎』を開発・運営しながら、県内の中小企業・個人事業主のAI導入や業務効率化のご相談をお受けしています。個人だからこそ、大きな会社には頼みにくい規模のご相談にも柔軟に対応できます。打ち合わせは平日夕方・土日が中心です。',
  ],
  linkLabel: '運営者情報を見る',
  linkHref: '/about',
}
